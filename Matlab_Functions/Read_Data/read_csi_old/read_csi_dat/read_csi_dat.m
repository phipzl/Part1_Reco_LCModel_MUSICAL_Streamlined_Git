...
if(isfield(ParList,'WipMemBlockInterpretation') && isfield(ParList.WipMemBlockInterpretation,'Prescan'))
	if(isfield(ParList.WipMemBlockInterpretation.Prescan,'NOISEADJSCAN') && isfield(ParList.WipMemBlockInterpretation.Prescan.NOISEADJSCAN,'Dwelltime') && ParList.WipMemBlockInterpretation.Prescan.NOISEADJSCAN.Dwelltime > 0)
	...
	if(isfield(ParList.WipMemBlockInterpretation.Prescan,'PATREFANDIMASCAN') && isfield(ParList.WipMemBlockInterpretation.Prescan.PATREFANDIMASCAN,'Dwelltime') && ParList.WipMemBlockInterpretation.Prescan.PATREFANDIMASCAN.Dwelltime > 0)
...
for CurrentMeasSet2 = transpose(fields(kSpace))
	...
	if(isfield(Info.General.Ascconv, 'WipMemBlockInterpretation') && isfield(Info.General.Ascconv.WipMemBlockInterpretation,'TwoDCaipi') && isfield(Info.General.Ascconv.WipMemBlockInterpretation.TwoDCaipi,'Skip_Matrix') && strcmp(CurrentMeasSet,'ONLINE'))
