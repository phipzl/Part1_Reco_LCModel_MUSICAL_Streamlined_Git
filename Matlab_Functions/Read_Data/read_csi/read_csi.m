function [iSpace,Noise,PreProcessingInfo,ReadInInfo,kSpace] = read_csi(coili,file,PreProcessingInfo,ReadInDataSets)
%
...
if(numel(strfind(file, '.dat')) > 0)
    ...
    % Read Raw Data
    [kSpace,ReadInInfo] = read_csi_dat_bu(file,0,ReadInDataSets,coili);
