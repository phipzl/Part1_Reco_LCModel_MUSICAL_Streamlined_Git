function [iSpace,Noise,PreProcessingInfo,ReadInInfo,kSpace] = read_csi_bu(coili,file,PreProcessingInfo,ReadInDataSets)
%
...
if(numel(strfind(file, '.dat')) > 0)
    ...
    % Read Raw Data
    [kSpace,ReadInInfo] = read_csi_dat_bu_NOISEDECO(file,0,ReadInDataSets,coili);
