...
if numel(max_adc_per_TI)==1
    we_use_const_TI_flag=1;
    fprintf('\nLooks like constant temporal Interleave data.')
else
    we_use_const_TI_flag=0;
    for i=1:max(Info.ONLINE.mdhInfo(14,:))-1
        NoOfTempInterleaves(NoOfTempInterleaves==max_adc_per_TI(i))=i;
    end
    fprintf('\nLooks like variable temporal Interleave data.')
end
%% 3. Reshape Data
