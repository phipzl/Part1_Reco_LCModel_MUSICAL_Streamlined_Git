...
%
% [svdRecombination, svdQuality, svdCoilAmplitudes] = svdReconstructFrequencyDomain(rawSpectra, noiseMask, ...)
%
...
% $Id: svdReconstructFrequencyDomain_v3_original.m 7363 2014-02-04 17:36:37Z crodgers $

function [svdRecombination, svdQuality, svdCoilAmplitudes, svdWeights] = svdReconstructFrequencyDomain_v3_mod(rawSpectra, noiseMat, varargin)
...
svdRescale = norm(svdCoilAmplitudes)*norm(svdCoilAmplitudes(options.phaseRefChannel));
