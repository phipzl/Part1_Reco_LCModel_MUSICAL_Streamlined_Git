...
for run=3:3    %   each run is for the calculation of a single fieldmap. 
    clear -regexp ^(?!run$).
    switch run
        case 1
        ...
        case 3
            ...
            data.root_dir = '/mokka1/projects/MRSI_Projects/Measurement_Data/Baseline_IR_Measurements/baseline_measurement_fieldmap_006';
            data.readfile_dirs = {'mag','phase'};
            data.writefile_dir = '/mokka1/projects/MRSI_Projects/Measurement_Data/Baseline_IR_Measurements/baseline_measurement_fieldmap_006/output';
