...
data.method = 'conj-diff'; %'phase-match'/'sep-channel'/'conj-diff' - these are PD,SC and HP in Robinson and Jovicich (MRM, 2011)
    %'pask = 0.4; % BET threshold for combined images - for masking fieldmap, should be quite lenient (low value; circa 0.4) - this is just the first step in denoising
