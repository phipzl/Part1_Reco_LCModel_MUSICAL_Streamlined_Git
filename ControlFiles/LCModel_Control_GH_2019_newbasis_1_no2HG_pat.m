...
ControlWrite.CHOMIT =  {'CHOMIT(1) = ''Cho''','CHOMIT(2) = ''Act''','CHOMIT(3) = ''mm3''','CHOMIT(4) = ''mm4''','CHOMIT(5) = ''Glc_B''', 'CHOMIT(6) = ''Lip_c''', 'CHOMIT(7) = ''Glc''', 'CHOMIT(8) = ''Lac''', 'CHOMIT(9) = ''AMLEA''', 'CHOMIT(10) = ''TwoHG'''}; % Names of omitted metabolites
