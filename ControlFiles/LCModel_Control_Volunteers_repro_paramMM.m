...
ControlWrite.NOMIT =  'NOMIT = 9';                               % Number of Metabolites within the Basis Set that should be omitted from the analysis
ControlWrite.CHOMIT =  {'CHOMIT(1) = ''Cho''','CHOMIT(2) = ''Act''','CHOMIT(3) = ''mm3''','CHOMIT(4) = ''mm4''','CHOMIT(5) = ''Glc_B''', 'CHOMIT(6) = ''Ala''', 'CHOMIT(7) = ''Lac''', 'CHOMIT(8) = ''TwoHG''','CHOMIT(9) = ''Gly'''}; % Names of omitted metabolites
