...
ControlWrite.NSIMUL = 'NSIMUL = 7';                              % Simulate Lipid signals to account for lipid contamination in 1.3ppm (provided by Marjanska,Jan2016)
...
ControlWrite.CHOMIT =  {'CHOMIT(1) = ''Cho''','CHOMIT(2) = ''Act''','CHOMIT(3) = ''mm3''','CHOMIT(4) = ''mm4''','CHOMIT(5) = ''Glc_B''', 'CHOMIT(6) = ''Ala''', 'CHOMIT(7) = ''Lac'''}; % Names of omitted metabolites
