...
ControlWrite.PPMREF = {'PPMREF(2,1) = 3.0'};                    % PPMREF(JREF,JCCF): What chemical shift should the delta function with number JREF for the Reference with number JCCF have?
...
ControlWrite.PPMEND = 'PPMEND = 2.5';
