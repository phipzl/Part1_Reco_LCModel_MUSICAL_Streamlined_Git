...
ControlWrite.NOMIT =  'NOMIT = 15';                               % Number of Metabolites within the Basis Set that should be omitted from the analysis
ControlWrite.CHOMIT =  {'CHOMIT(1) = ''Cho''','CHOMIT(2) = ''Act''','CHOMIT(3) = ''mm3''','CHOMIT(4) = ''mm4''','CHOMIT(5) = ''Glc_B''', 'CHOMIT(6) = ''Lip_c''', 'CHOMIT(7) = ''Glc''', 'CHOMIT(8) = ''Lac''', 'CHOMIT(9) = ''AMLEA''', 'CHOMIT(10) = ''Ala''', 'CHOMIT(11) = ''Thr''', 'CHOMIT(12) = ''Try''', 'CHOMIT(13) = ''Ctn''', 'CHOMIT(14) = ''MM_mea''', 'CHOMIT(15) = ''TwoHG''', 'CHOMIT(16) = ''Cit'''}; % Names of omitted metabolites
