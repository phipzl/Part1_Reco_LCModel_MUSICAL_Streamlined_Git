...
% Analysis Window
ControlWrite.PPMST = 'PPMST = 3.88';                              % Fit data in chemical shift region [PPMEND, PPMST], PPMST > PPMEND
ControlWrite.PPMEND = 'PPMEND = 0.2';
%ControlWrite.PPMGAP = {'PPMGAP(1,1)=4.1', 'PPMGAP(2,1)=3.85 '};
...
ControlWrite.NOMIT =  'NOMIT = 14';                               % Number of Metabolites within the Basis Set that should be omitted from the analysis
ControlWrite.CHOMIT =  {'CHOMIT(1) = ''Cho''','CHOMIT(2) = ''Act''','CHOMIT(3) = ''mm3''','CHOMIT(4) = ''mm4''','CHOMIT(5) = ''Glc_B''', 'CHOMIT(6) = ''Lip_c''', 'CHOMIT(7) = ''Glc''', 'CHOMIT(8) = ''Lac''', 'CHOMIT(9) = ''AMLEA''', 'CHOMIT(10) = ''MM_mea''', 'CHOMIT(11) = ''TwoHG''', 'CHOMIT(12) = ''Ctn''', 'CHOMIT(13) = ''Try''', 'CHOMIT(14) = ''Cit'''}; % Names of omitted metabolites
