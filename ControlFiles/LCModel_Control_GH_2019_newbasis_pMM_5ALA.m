...
ControlWrite.PPMGAP = {'PPMGAP(1,1)=1.8', 'PPMGAP(2,1)=1.15 '};
...
ControlWrite.NOMIT =  'NOMIT = 11';                               % Number of Metabolites within the Basis Set that should be omitted from the analysis
ControlWrite.CHOMIT =  {'CHOMIT(1) = ''Cho''','CHOMIT(2) = ''Act''','CHOMIT(3) = ''mm3''','CHOMIT(4) = ''mm4''','CHOMIT(5) = ''Glc_B''', 'CHOMIT(6) = ''Lip_c''', 'CHOMIT(7) = ''Glc''', 'CHOMIT(8) = ''Lac''', 'CHOMIT(9) = ''Ala''', 'CHOMIT(10) = ''Thr''', 'CHOMIT(11) = ''Try''', 'CHOMIT(11) = ''MM_mea'''}; % Names of omitted metabolites
